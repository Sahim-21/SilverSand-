...
| Address, photos, amenities, GBP   | Address + map live. **Room occupancy photos live** (`public/Rooms/`). **Nearby attraction photos live** (`public/tourist_places/`). Exterior photos still missing. **Bathroom available** (photos of it still missing). **1 km from Murudeshwar bus stand**. GST included in listed rates. ID required at check-in. Public pages have **no** `TodoNotice` / pending-owner boxes. |
