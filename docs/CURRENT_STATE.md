...
| Address, photos, amenities, GBP   | Address + map live. **Room occupancy photos live** (`public/Rooms/`). **Nearby attraction photos live** (`public/tourist_places/`). Exterior photos still missing. The Deluxe AC Room **has a bathroom** (photos of it still missing). **1 km from Murudeshwar bus stand**. GST included. ID required at check-in. Public copy is guest-facing (no `TodoNotice`, no developer-note phrasing). |
