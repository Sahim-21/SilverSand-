...
| Address, photos, amenities, GBP   | Address + map live. **Room occupancy photos live** (`public/Rooms/`). **Nearby attraction photos live** (`public/tourist_places/`). Exterior/bathroom still missing; landmark distances still unpublished. Confirmed amenities (AC, Wi-Fi, parking, meals-not-offered, check-in/out, cancellation) use normal copy, not “pending owner” scaffolding. |
