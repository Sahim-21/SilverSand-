...
| Marketing sections                | Reusable components under `src/components/sections/` and `src/components/marketing/`. Public **site header is sticky** (`top-0 z-50`) with a compact theme toggle.                                                                                                                                                                                                                                           |
